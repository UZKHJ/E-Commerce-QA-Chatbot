...
################### FOR GCLOUD DEPLOYMENT Only################
# The reason project is not deployed on the cloud is because
# GCoud only gave me 4.5G of space for files and packages
# and i am using sentence transformer which alone takes about 80%
# of the space therefore i keep on getting Not Enough Space Error
# after deploying and during package installation.

# API KEY from GCLOUD SECRET MANAGER
# def access_secret_version(secret_id, version_id="latest"):
#     # Create the Secret Manager client.
#     client = secretmanager.SecretManagerServiceClient()
#     Project_ID = "text-analytics"
...
#Loads all the files in TrainingCorpus folder
loader = DirectoryLoader("./TrainingCorpus")
txt = loader.load()
